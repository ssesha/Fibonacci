...
import com.icreate.projectx.TaskListActivity.ListTask;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			...
			if (!(projectString.isEmpty())) {
				...
				GetTaskList ListTasks = new GetTaskList(cont,
						currentActivity, dialog, memberListView);
		...
		TaskView.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				System.out.println("project_id in project_view"+ project.getProject_id());
