...
public class CalendarServiceBuilder {
	...
	public static Calendar build(String accessToken) {
		...
		Calendar service = Calendar.builder(transport, jsonFactory).setApplicationName("Google-Meeting-Scheduler/1.0").setJsonHttpRequestInitializer(new JsonHttpRequestInitializer() {
			@Override
