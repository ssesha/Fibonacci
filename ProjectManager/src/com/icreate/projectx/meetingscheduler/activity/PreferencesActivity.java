...
public class PreferencesActivity extends PreferenceActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final Preference selectedAccountPref =
        getPreferenceScreen().findPreference(Constants.SELECTED_ACCOUNT_PREFERENCE);
  ...
  protected Dialog onCreateDialog(int id) {
    switch (id) {
      case WORKING_HOURS_START_ID:
        return createTimePickerDialog(Constants.WORKING_HOURS_START_PREFERENCE,
            getString(R.string.working_hours_start_default_value));
      case WORKING_HOURS_END_ID:
        return createTimePickerDialog(Constants.WORKING_HOURS_END_PREFERENCE,
   ...
   * @param dialogID Preference dialog's ID.
   */
  ...
  private Dialog createTimePickerDialog(final String key, String defaultValue) {
    ...
    }, Integer.parseInt(workingHours[0]), Integer.parseInt(workingHours[1]),
