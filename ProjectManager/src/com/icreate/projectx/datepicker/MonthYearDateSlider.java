...
package com.icreate.projectx.datepicker;
...
public class MonthYearDateSlider extends DateSlider {
	...
	/**
	 * override the setTitle method so that only the month and the year are
	 * shown.
	 */
	@Override
	protected void setTitle() {
		if (mTitleText != null) {
			mTitleText.setText(getContext().getString(R.string.dateSliderTitle) + String.format(": %tB %tY", mTime, mTime));
		}
	}
